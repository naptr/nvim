...
local Diagnostics = {
    ...
    update = { "DiagnosticChanged", "BufEnter" },
    {
        ...
        end,
        {
            ...
            hl = function()
                local fg = utils.get_highlight("DiagnosticError").fg
                return { fg = fg }
            end
        },
        {
    ...
    },
    {
        ...
        },
        {
            ...
            hl = function()
                local fg = utils.get_highlight("DiagnosticWarn").fg
                return { fg = fg }
            end
        },
        {
    ...
    },
    {
        ...
        },
        {
            ...
            hl = function()
                local fg = utils.get_highlight("DiagnosticInfo").fg
                return { fg = fg }
            end
        },
        {
    ...
    },
    {
        ...
        },
        {
            ...
            hl = function()
                local fg = utils.get_highlight("DiagnosticOk").fg
                return { fg = fg }
            end
        },
        {
